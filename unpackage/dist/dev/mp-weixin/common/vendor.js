...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"uni-novel","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! @/config/config.js */ 12));

var _vue = _interopRequireDefault(__webpack_require__(/*! vue */ 2));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}console.log(_config.default);var _default =
...
/* 13 */
/*!***************************************!*\
  !*** D:/htd/uni-novel/store/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  function Water(url, flowList, recommendList, self) {_classCallCheck(this, Water);
    ...
    {var _this = this;
      this.self.request('post', this.url).then(function (res) {
        _this.recommendList = res.recommandlist || res.online || res.boy.remommand;
        _this.addRandomData();
      });
...
/* 116 */
/*!*******************************************!*\
  !*** D:/htd/uni-novel/common/catogory.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports) {

function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}var User = /*#__PURE__*/function () {"use strict";
  function User(url, self, catogoryList) {_classCallCheck(this, User);
    this.url = url;
    this.self = self;
    this.catogoryList = catogoryList;
    // this.dataList = dataList
  }_createClass(User, [{ key: "getCatogoryList", value: function getCatogoryList()
    {var _this = this;
      this.self.request('post', this.url).then(function (res) {
        var result = res.girl.catogory;
        // console.log(result);
        res.girl.catogory.forEach(function (item) {
          _this.catogoryList.push(item);
        });
